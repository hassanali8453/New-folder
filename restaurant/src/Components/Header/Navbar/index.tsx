...
//   return (
// <nav className="bg-white bg-opacity-90 fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-300">
...
//       <button onClick={toggleSidebar} type="button" className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden">
//       <IoMdMenu />
//     </button>
//   </div>
